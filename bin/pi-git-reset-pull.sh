...
echo ""
echo "Next (prefer artifact — do not compile on the Pi):"
echo "  # On Mac: ./bin/p49-build-release.sh && ./bin/p49-push-release.sh rasohoni@pi.home.arpa"
echo "  sudo ./deploy/rpi/install.sh --break-glass-compile   # gated compile path only"
